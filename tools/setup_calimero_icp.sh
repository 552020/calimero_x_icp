...
# Reference Notes:
# To create an invitation use:
# meroctl context invite <CONTEXT_ID> <INVITER_ID> <INVITEE_ID>
# where:
# - CONTEXT_ID: The id of the context for which invitation is created
# - INVITER_ID: The public key of the inviter (host node)
# - INVITEE_ID: The public key of the invitee (joining node)
#
# Example commands used in this script:
# meroctl --node-name node1 context invite $context_id $member_public_key $node2_public_key
# meroctl --node-name node1 context invite $context_id $member_public_key $node3_public_key
