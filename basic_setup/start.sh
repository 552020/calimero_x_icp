...
dfx canister logs context_contract > /dev/null 2>&1
if [ $? -ne 0 ] ; then
  ...
  dfx canister call context_contract logs > /dev/null 2>&1
    if [ $? -ne 0 ] ; then
...
# Cf3SwcyF9gcC9j1YNfgkDvHkKzjnpajs4cz7QQtt5yD5 - kv_store

# 975PyY76E8X1qMdExt7B9SimtCnDeXn6J3kyuf3MiWuK - context_contract

application install file /Users/${USER}/Desktop/kv-store/calimero_x_icp_hackathon/basic_setup/context/res/kv_store.wasm

context create --protocol icp 975PyY76E8X1qMdExt7B9SimtCnDeXn6J3kyuf3MiWuK
